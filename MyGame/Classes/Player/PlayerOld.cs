...
using System;
using MyGame.Classes.interfaces;

namespace MyPlayer
{
    internal class PlayerOld : HasAnimations
    {
        //ENUMS 
        //ACTION ENUM
        enum CurantMovment
        ...
        //CONSTRUCTOR
        public PlayerOld(RectangleF playerRect)
        {
            Intelize();
        ...
        public void SetExternVelocty(Vector2 velocty)
        {
            m_ExternVelocity.X = velocty.X;
            m_ExternVelocity.Y = velocty.Y;
        }
